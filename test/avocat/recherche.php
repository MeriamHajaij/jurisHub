...
<head>
    ...
    <title>Page Recherche | JurisHub</title>
    ...
    <aside class="sidebar">
        ...
        <div class="nav-container">
            <ul class="nav-links">
                ...
                <li class="nav-item">
                    <a href="rehcerche.php" class="nav-link active">
    ...
    <main class="main-content">
        <div class="page-header">
            ...
            <p class="page-description">
                Sélectionnez une catégorie pour accéder aux outils de recherche spécifiques.
            </p>
        </div>
        ...
        <form class="search-section">
            <div class="search-options">
                <label class="search-option">
                    ...
                    <h3>Clients</h3>
                    <p>Rechercher parmi vos clients</p>
                    <button href="clients.php" name="recherche" value="clients" class="search-btn">
                ...
                <label class="search-option">
                    ...
                    <h3>Membres</h3>
                    <p>Rechercher parmi les membres</p>
                    <button href="membre.php" name="recherche" value="membre" class="search-btn">
                        <i class="fas fa-arrow-right"></i> Accéder
                    </button>
                </label>
                ...
                <label class="search-option">
                    ...
                    <h3>Staff</h3>
                    <p>Rechercher dans le personnel</p>
                    <button href="staff.php" name="recherche" value="staff" class="search-btn">
                        <i class="fas fa-arrow-right"></i> Accéder
                    </button>
                </label>
                
                <div href="affjud.php"  class="search-option">
                    <i class="fas fa-gavel"></i>
                    <h3>Affaires Judiciaires</h3>
                    <p>Rechercher parmi vos dossiers</p>
